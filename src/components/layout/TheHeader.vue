    ...
    <article>
      <nav>
        <ul>
          <li class="brand">
            <router-link to="/">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112.8 103.84">
                <path class="a"
        ...
        <ul class="right">
          <li>
            <router-link :to="{ name: 'searchArticls' }" class="search-articls">
              <vue-feather size="2rem" type="search" aria-label="Search"></vue-feather>
            </router-link>
          </li>

          <li v-if="!isLoggedIn">
            <router-link to="/users/me">
              <vue-feather size="2rem" type="user" aria-label="User"></vue-feather>
            </router-link>
          </li>
          ...
          <li v-else>
            <details role="list">
              ...
              <ul role="listbox">
                <li>
                  <input @click="toggleTheme()" type="checkbox" id="theme" name="theme" role="switch"
                    :checked="theme === 'dark'" />
                  {{ theme }}
                </li>
                ...
                <li>
                  <div class="grid">
                    <div>
                      <a class="less-margin" href @click.prevent="setTextSize(0.8)">
                        <vue-feather size="0.6rem" type="type" aria-label="Small text"></vue-feather>
                      </a>
                    </div>

                    <div>
                      <a class="less-margin" href @click.prevent="setTextSize(1)">
                        <vue-feather size="0.8rem" type="type" aria-label="Normal text"></vue-feather>
                      </a>
                    </div>

                    <div>
                      <a class="less-margin" href @click.prevent="setTextSize(1.2)">
                        <vue-feather size="1rem" type="type" aria-label="Large text"></vue-feather>
                      </a>
                    </div>
                  </div>
                </li>
                <li>
                  <router-link class="less-margin" to="/users/me">Edit profile</router-link>
                </li>
                <li>
                  <a href="#" @click.prevent="logout" class="less-margin">Log out</a>
                </li>
                <li>
                  <a href="#" @click.prevent="clearLocalData" class="less-margin">For development: clear data</a>
                </li>
              </ul>
            </details>
          </li>
