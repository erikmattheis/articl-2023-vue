              ...
              <ul role="listbox">
                    ...
                    <div>
                      <a
                        ...
                        <vue-feather
                          size="0.6rem"
                          type="type"
                          aria-label="Small text" /><span class="sr">Small text</span>
                      </a>
                    </div>
                    ...
                    <div>
                      <a
                        ...
                        <vue-feather
                          size="0.8rem"
                          type="type"
                          aria-label="Normal text" /><span class="sr">Normal text</span>
                      </a>
                    </div>
                    ...
                    <div>
                      <a
                        ...
                        <vue-feather
                          size="1rem"
                          type="type"
                          aria-label="Large text" /><span class="sr">Large text</span>
                      </a>
                    </div>
                  </div>
                </li>
                ...
                <li>
                  <a
                    href="#"
                    class="less-margin"
                    @click.prevent="clearLocalData">For development: clear data</a>
                </li>
              </ul>
            </details>
          </li>
